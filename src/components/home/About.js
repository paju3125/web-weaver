        ...
        <section className="text-gray-600 body-font" id="about" style={{ fontFamily: 'Inter', marginTop: "12%" }}>
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center" style={{ margin: "auto", width: "100%" }}>
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed" style={{ width: "auto" }}>Manayunkia Residential Homestay is a house constructed in adherence with Vastu Shastra, encircled by beautiful, calm, and pristine nature on all four sides. It is located opposite the adventure park of Pothundy Dam in Nemmara village,
                    ...
                    <div className="flex justify-center">
                        <span className="inline-flex rounded-md shadow-sm">
                            <a href="story.html" className="button button__header focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Know More</a>
                        </span>
                    </div>
                </div>
            </div>
